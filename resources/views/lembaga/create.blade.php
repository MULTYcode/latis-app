...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold mb-4">Tambah Lembaga</h1>
    ...
    <form action="{{ route('lembaga.store') }}" method="POST" class="max-w-lg">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea id="keterangan" name="keterangan" rows="4"
                class="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('keterangan') }}</textarea>
        </div>
